...
void Global::button(FUNCTION func1, FUNCTION func2)
{
	get_console_size(&console);
	int x1 = console.cols / 2;
	int x2 = console.cols / 2;
	int y1 = console.cols / 2;
	int y2 = console.cols / 2;
...
void Global::timer(int time1, int time2, string desc1, string desc2, string desc3, string desc4, FUNCTION func1, FUNCTION func2)
{
